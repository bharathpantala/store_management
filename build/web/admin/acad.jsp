...
<nav class="navbar navbar-default navbar-static-top">
                ...
                <li class="dropdown ">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="divider"></li>
                            <li class="active"><a href="acad.jsp">Academic year-wise report</a></li>
                            <li class="divider"></li>
    ...
    <div class="panel-body">
      ...
      <form method="POST" action="#">
        ...
        <select class="form-control" style="display: inline;" autofocus="" required="" name="clg" id="clg">
          ...
          <label>Select Department :</label>
           ...
           %>
                ...
                <select class="form-control" style="display: inline;" autofocus="" required="" name="ayear" id="ayear">
                       <%
                ss = conn.select("select distinct(a_year) from s_order");
            while(ss.next())
            {
              out.print("<option>"+ss.getString("a_year")+"</option>");
            }
           %>
                </select>
                </div>
        ...
        ResultSet a =  d.select("SELECT ((sum(s_qty.qty)*`s_order`.`no_of_stud`)) as tqty,s_items.items, s_qty.qty, s_order.no_of_stud FROM `s_items` INNER JOIN `s_qty` on s_items.id = s_qty.item_id  INNER JOIN `s_order` on s_order.o_id = s_qty.o_id and s_order.clg='"+clg1+"' and s_order.dep='"+dept+"' and s_order.a_year='"+ayear+"' GROUP by s_qty.item_id order by s_items.items");
        ResultSet nos = d.select("SELECT no_of_stud FROM s_order where clg='"+clg1+"' and dep='"+dept+"' and a_year='"+ayear+"'");     
               clg1="";
        ...
        i=1;
        %>
        <h2>No. of students: <% while(nos.next())out.print(nos.getInt("no_of_stud")); %></h2>
