...
<form method="POST" action="Additem">
  ...
  <input type="text" name="itemname" class="form-control" style="display: inline;">
</div>
<div class="col-sm-4">
  <label>Stock: </label>
  <input type="number" name="stock" class="form-control" style="display: inline;" value="0">
</div>
</div>
<h3 style="color: red">${errorMessage}</h3>
<center><input type="submit" value="Add Item" name="additembtn" class="form-control btn-primary" style="width: 20%"></center>
</form>
