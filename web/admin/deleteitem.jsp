...
@media (max-width: 768px) {
   ...
   <script type="text/javascript">
    function f(){
        ...
        var d = document.getElementById("itm");
                ...
                <li class="dropdown ">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="divider"></li>
                            <li class="active"><a href="deleteitem.jsp">Delete Item</a></li>
                            <li class="divider"></li>
...
<div class="row">
  ...
  <label>Select item name: </label>
        <select class="form-control" name="deleteitem" id="deleteitem" onchange="f()">
           
           <%
            config.Dbconnection con = new config.Dbconnection();
            ResultSet s = con.select("select items from s_items order by items");
            while(s.next())
            {
              out.print("<option>"+s.getString("items")+"</option>");
            }
           %>
                  ...
                  <div class="col-sm-4">
  <label>Item to be deleted: </label><br>
           <input type="text" id="itm" style="border:none; width: 100%; color: red" readonly>
       </div>
           <script type="text/javascript">document.write(deleteitm.value)</script>
</div>

    <h3 style="color: red;">${errorMessage}</h3>
<center><input type="submit" value="Delete Item" name="delitembtn" class="form-control btn-primary" style="width: 20%"></center>
</form>
   <br>
    </div>
</div>
