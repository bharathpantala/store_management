...
<script>
    function printData()
    {
        ...
        printWindow.document.write("<html><head><title>Closing stock</title>");
...
<nav class="navbar navbar-default navbar-static-top">
                ...
                <li class="dropdown ">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="divider"></li>
                            <li class="active"><a href="closing.jsp">Closing stock</a></li>
                            <li class="divider"></li>
   ...
   <table class="table table-bordered">
            <thead>
      <tr>
        <td>Sr. no.</td><td> Items names</td><td> Stock</td>
      </tr>
    </thead><tbody>
            <%
        config.Dbconnection d =new Dbconnection();
        ResultSet a =  d.select("SELECT * from s_items order by items");
...
<center><input type='submit' id='printsub' class='form-control btn-primary' value='Print' onclick='return printData()' style='width:20%; margin-bottom:2%'></center>
