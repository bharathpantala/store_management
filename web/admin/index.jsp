  ...
  Welcome ${user}
   ...
   <table class="table table-bordered">
      ...
      <tr>
        ...
        ResultSet a =  d.select("SELECT (sum((s_qty.qty)*`s_order`.`no_of_stud`)) as qty,s_items.items FROM `s_items` INNER JOIN `s_qty` on s_items.id = s_qty.item_id INNER JOIN `s_order` on s_order.o_id = s_qty.o_id GROUP by s_qty.item_id");
